...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_13|GPIO_PIN_14|LED0_Pin, GPIO_PIN_SET);
  ...
  GPIO_InitStruct.Pin = GPIO_PIN_13|GPIO_PIN_14|LED0_Pin;
  ...
  GPIO_InitStruct.Pin = CN_CHARGE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(CN_CHARGE_GPIO_Port, &GPIO_InitStruct);
