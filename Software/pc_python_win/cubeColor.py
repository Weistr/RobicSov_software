...
def color_know(hsv, cube_color_centre, face_name, color_name, i, j, k, num, C_A, C_B):  # 颜色识别函数
    ...
    if C_B[4][0] > 160 and C_B[2][0] < 55:
        ...
        C_B[3][0] = 75
        C_B[3][1] = 240
    if C_B[0][0] < 5 and C_B[1][0] < 5 and C_B[5][0] >160 :
        C_B[5] = C_B[3]
    ...
    if C_B[4][0] > 160:
        if (hsv_color[1] < C_A[1][1]) and (abs(hsv_color[1] - C_A[0][1]) < abs(hsv_color[1] - C_A[1][1])) and (hsv_color[0] > 60) or (hsv_color[1] < 53):
            cube_lump[1] = color_name[0] or (90 < hsv_color[0] < 110 and hsv_color[1] < C_A[1][1] ) # W
        ...
        if ((hsv_color[1] < C_A[1][1]) and (abs(hsv_color[1] - C_A[0][1]) < abs(hsv_color[1] - C_A[1][1])) and (hsv_color[0] > 60)) or (hsv_color[1] < 53)\
            ...
            if (abs(hsv_color[0] - C_B[3][0]) < abs(hsv_color[0] - C_B[2][0])) and hsv_color[1] > 125:
                cube_lump[1] = color_name[2]  # G
            elif (C_B[3][0] + 5 > hsv_color[0] > C_B[3][0] - 5 )and (hsv_color[1] < 100):
                cube_lump[1] = color_name[2]  # G
            else:
                cube_lump[1] = color_name[3]  # Y
            ...
            if (abs(hsv_color[1] - C_B[1][1]) < abs(hsv_color[1] - C_B[0][1])) and hsv_color[2] > 195:
                ...
                cube_lump[1] = color_name[4]  # O
            elif (abs(hsv_color[1] - C_B[1][1]) < abs(hsv_color[1] - C_B[0][1])) or hsv_color[2] > 198:
                cube_lump[1] = color_name[4]  # O
            else:
                cube_lump[1] = color_name[5]  # R
    ...
    if tmp >= 10 and hsv_color[2] <  130 or (hsv_color[0] > 145) :
        cube_lump[1] = color_name[5]# R
    ...
    if hsv_color[0] <  C_B[0][0] and  (hsv_color[2] > 180) :
        cube_lump[1] = color_name[5]# R
    if hsv_color[0] <  C_B[0][0] and  (hsv_color[2] < 100) :
        cube_lump[1] = color_name[5]# R
    if (hsv_color[2] > 210 and 0.3 < hsv_color[0] < C_B[1][0]) or (hsv_color[2] > 240 and hsv_color[0] > 175) or (hsv_color[2] > 222 and hsv_color[0] < 5):
        cube_lump[1] = color_name[4]# O
    if hsv_color[1]< 20:
        cube_lump[1] = color_name[0]# W
    return cube_lump
...
# 拍照下###################################################################################
video_takephoto(4)
img1 = cv2.imread('4.jpg')  # 图片2,识别左L,右B
...
ser2.close()
# 坐标上
PixelAarry_0 = [[195, 115], [255, 105], [330, 100],
                [195, 215], [250, 220], [320, 220],
                [190, 310], [250, 330], [325, 350],
                [420, 105], [495, 110], [550, 115],
                [410, 230], [490, 225], [550, 220],
                [415, 350], [490, 330], [545, 315]]
# 坐标下
PixelAarry_1 = [[250, 170], [265, 105], [270, 55],
                [350, 175], [350, 110], [355, 60],
                [455, 175], [445, 110], [450, 55],
...
PixelAarry_3 = [[135, 215], [225, 120], [315, 35],
                ...
                [325, 395], [425, 310], [500, 205],
                ]
# 坐标右
PixelAarry_2 = [[315, 390], [200, 300], [140, 190], [415, 290], [320, 200],  [230, 105], [495, 195], [410, 105], [315, 30],
                ]
